...
FOLDER_PATTERN="logs/episodes/alfworld_test/eval_out_of_distribution/rap_flex/openai/gpt-4o-mini/pbt_zero_trial_*_6ic_*"
...
REGEX_PATTERN="pbt_zero_trial_(\\d+)_6ic_(\\d+)"

# Output file path
OUTPUT_PATH="alfworld_test_pbt_zero_success_rate_plot.png"
