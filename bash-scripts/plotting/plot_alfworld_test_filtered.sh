...
FOLDER_PATTERN="logs/episodes/alfworld_test/eval_out_of_distribution/rap_flex/openai/gpt-4o-mini/alfworld_best_examples_6_ic_*_trial_*"
...
REGEX_PATTERN="alfworld_best_examples_6_ic_(\\d+)_trial_(\\d+)"

# Output file path
OUTPUT_PATH="alfworld_filtered_test_success_rate_plot.png"
