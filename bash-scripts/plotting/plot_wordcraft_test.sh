...
FOLDER_PATTERN="logs/episodes/wordcraft/test/rap_noplan/openai/gpt-4o-mini/wordcraft_depth_2_humanic_test_*_10ic_*"
...
REGEX_PATTERN="wordcraft_depth_2_humanic_test_(\\d+)_10ic_(\\d+)"

# Output file path
OUTPUT_PATH="wordcraft_test_success_rate_plot.png"
...
FOLDER_PATTERN="logs/episodes/wordcraft/test/rap_noplan/openai/gpt-4o-mini/wordcraft_baseline_*"
OUTPUT_PATH="wordcraft_test_pass_at_k_plot.png"
