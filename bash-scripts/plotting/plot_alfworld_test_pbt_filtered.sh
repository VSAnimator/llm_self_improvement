...
FOLDER_PATTERN="logs/episodes/alfworld_test/eval_out_of_distribution/rap_flex/openai/gpt-4o-mini/alfworld_pbt_best_examples_6_ic_*_trial_*"
...
REGEX_PATTERN="alfworld_pbt_best_examples_6_ic_(\\d+)_trial_(\\d+)"

# Output file path
OUTPUT_PATH="alfworld_pbt_best_examples_test_success_rate_plot.png"
