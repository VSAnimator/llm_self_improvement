...
FOLDER_PATTERN="logs/episodes/wordcraft/test/rap_noplan/openai/gpt-4o-mini/pbt_best_examples_trial_*_10ic_*"
...
REGEX_PATTERN="pbt_best_examples_trial_(\\d+)_10ic_(\\d+)"

# Output file path
OUTPUT_PATH="wordcraft_pbt_best_examples_test_success_rate_plot.png"

# Segment size (number of most recent tasks to consider)
SEGMENT_SIZE=1000

# Run the plotting script
echo "Plotting Wordcraft PBT test success rates..."
