...
FOLDER_PATTERN="logs/episodes/wordcraft/test/rap_noplan/openai/gpt-4o-mini/pbt_trial_*_10ic_*"
...
REGEX_PATTERN="pbt_trial_(\\d+)_10ic_(\\d+)"

# Output file path
OUTPUT_PATH="wordcraft_pbt_test_success_rate_plot.png"
