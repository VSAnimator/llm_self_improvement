...
FOLDER_PATTERN="logs/episodes/intercode_sql/test/rap_noplan/openai/gpt-4o-mini/intercode_sql_spider_best_*_trial_*"
...
REGEX_PATTERN="intercode_sql_spider_best_(\\d+)_trial_(\\d+)"

# Output file path
OUTPUT_PATH="intercode_sql_filtered_test_success_rate_plot.png"
