...
FOLDER_PATTERN="logs/episodes/intercode_sql/test/rap_noplan/openai/gpt-4o-mini/intercode_pbt_trial_*_6ic_*_test"
...
REGEX_PATTERN="intercode_pbt_trial_(\\d+)_6ic_(\\d+)_test"

# Output file path
OUTPUT_PATH="intercode_sql_pbt_test_success_rate_plot.png"

# Segment size (number of most recent tasks to consider)
SEGMENT_SIZE=1000

# Run the plotting script
echo "Plotting InterCode SQL PBT test success rates..."
