    ...
    async def choose_action(self, obs, valid_actions):
        ...
        if self.in_context_data is None:
            ...
            self.in_context_data = self.retrieve_trajectory_data(
                key_types=[
                    "goal",
                    "observation",
                ],  # Match examples with similar goals and observations
                ...
                value_types=[
                    ...
                    "reasoning",
                    "action",
                ],  # Extract full state information
        ...
        self.in_context_data = self.retrieve_state_data(
            trajectory_key_types=[
                "goal",
                "reasoning",
            ],  # Find trajectories with similar goals and reasoning
            trajectory_keys=[self.goal, reasoning],
            state_key_types=[
                "reasoning"
            ],  # Find states with similar reasoning within those trajectories
