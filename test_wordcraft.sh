...
do
    ...
    do
        python scripts/run_agent_v2.py --llm openai/gpt-4o-mini --agent_type rap_noplan --num_passes 1 --env wordcraft_test --num_tasks 500 --parallel 5 --num_ic 10 --start_task 0 --log_name wordcraft_depth_2_humanic_test_${trial}_10ic_${db_size} --db_path $CURRENT_DIR/data/wordcraft/depth2_humanic_train_${trial}_backups/${db_size}/learning.db/learning.db &
        sleep 10
    done
    wait
done
